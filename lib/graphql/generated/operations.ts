...
export type MakeOptional<T, K extends keyof T> = Omit<T, K> & {
  [SubkeyOf in K]?: Maybe<T[SubkeyOf]>;
};
...
export function useGetAnimePageQuery(
  baseOptions?: Apollo.QueryHookOptions<GetAnimePageQuery, GetAnimePageQueryVariables>
) {
...
export function useGetAnimePageLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetAnimePageQuery, GetAnimePageQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
